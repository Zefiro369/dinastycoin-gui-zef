...
void TailsOS::showDataPersistenceDisabledWarning()
{
    ...
    msgBox.setInformativeText(
        QObject::tr("Dinastycoin GUI has detected that Tails persistence is "
                     "currently disabled. Any configurations you make inside "
                     "the Dinastycoin GUI will not be saved."
                     "\n\n"
...
{
    QMessageBox msgBox;
    msgBox.setWindowTitle(QObject::tr("Dinastycoin GUI"));
